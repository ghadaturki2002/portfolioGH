...
- **Projet embarqué STM32 (I2C & UART)** → ✅ NOUVEAU projet ajouté (15ᵉ), **2024, un semestre**. ⚠️ Projet le moins détaillé : j'ai mis **uniquement les faits confirmés** (STM32, I2C/UART, capteur ultrason, moteur, boutons, LCD, simulation Proteus) sans inventer le scénario. **À me préciser** : l'**école**, **individuel/équipe**, ton **rôle**, le **scénario réel** (qui fait quoi : I2C/UART), et le **résultat concret**. 📷 Emplacement réservé → `public/stm32.jpg`.
