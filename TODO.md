...
- **Simulateur de pannes + app de diagnostic** → ✅ contenu détaillé intégré (PFE Licence Génie mécanique, **ISETN, 2023**, binôme, avec MATECH ; banc Guard Revolution + Arduino, app Java ; **en cours d'utilisation chez MATECH**). Médias réels conservés. *Optionnel* : la **durée exacte** du PFE (l'expérience indique févr.–juin 2023) ; confirme que l'app est bien en **Java**.
